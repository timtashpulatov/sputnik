...
U 1 1 5807B163
P 2600 2125
F 0 "IC1" H 2125 3400 60  0000 C CNN
F 1 "EP4CE10F17" H 2600 2850 60  0000 C CNN
F 2 "lib:BGA-256-NSMD" H 2600 3700 60  0001 C CNN
F 3 "" H 500 75  60  0000 C CNN
F 4 "EP4CE10F17" H 3050 3375 60  0000 C CNN "Component Value"
	1    2600 2125
	1    0    0    -1  
$EndComp
$Comp
...
F 4 "EP4CE10F17" H 8575 3500 60  0000 C CNN "Component Value"
	2    8125 2250
	1    0    0    -1  
$EndComp
$Comp
...
F 4 "EP4CE10F17" H 8550 5325 60  0000 C CNN "Component Value"
	3    8125 4075
	1    0    0    -1  
$EndComp
$Comp
...
F 4 "EP4CE10F17" H 12750 6800 60  0000 C CNN "Component Value"
	10   12775 5550
	1    0    0    -1  
$EndComp
$Comp
...
U 1 1 5807C448
P 12075 6725
F 0 "#PWR14" H 12075 6475 50  0001 C CNN
...
VREFB1N0
Text Label 3650 1275 0    60   ~ 0
TDI
Text Label 3650 1350 0    60   ~ 0
TCK
Text Label 3650 1425 0    60   ~ 0
TMS
Text Label 3650 1500 0    60   ~ 0
TDO
Text Label 3725 1200 0    60   ~ 0
nCONFIG
Text Label 3825 1125 0    60   ~ 0
DATA0
Text HLabel 1800 9175 0    60   Input ~ 0
SD_[0..7]
...
SD_7
Text HLabel 1775 5575 0    60   Input ~ 0
AD_[8..31]
...
AD_8
Text HLabel 1725 8275 0    60   BiDi ~ 0
FC_[0..2]
...
F 4 "EP4CE10F17" H 8650 7525 60  0000 C CNN "Component Value"
	4    8175 6275
	1    0    0    -1  
$EndComp
Text HLabel 1775 8800 0    60   BiDi ~ 0
nDS_[0..3]
Entry Wire Line
	1900 8925 2000 8825
Entry Wire Line
...
nDS_0
Text Label 2050 8825 0    50   ~ 0
nDS_1
Text Label 2050 8900 0    50   ~ 0
nDS_2
Entry Wire Line
	1900 9075 2000 8975
Text Label 2050 8975 0    50   ~ 0
nDS_3
...
nMTCR
Text HLabel 1700 7800 0    60   BiDi ~ 0
A_[2..7]
...
USING RUP1, RDN1 ?????
Text HLabel 1700 7500 0    60   Output ~ 0
DIR_AD
Text HLabel 1775 6700 0    60   Output ~ 0
nOE_AD
...
U 1 1 57F7A288
P 2675 3000
F 0 "#PWR5" H 2675 2750 50  0001 C CNN
...
U 1 1 57F8D5C6
P 13775 2025
F 0 "#PWR16" H 13875 2075 20  0001 C CNN
...
U 1 1 57F8FD8F
P 13775 2325
F 0 "#PWR17" H 13775 2075 50  0001 C CNN
...
U 1 1 57F90743
P 13275 1400
F 0 "#PWR15" H 13275 1150 50  0001 C CNN
...
F 4 "EP4CE10F17" H 8525 9650 60  0000 C CNN "Component Value"
	5    8125 8400
	1    0    0    -1  
$EndComp
$Comp
...
Wire Wire Line
	12500 3650 14300 3650
Wire Wire Line
	12550 3525 12500 3525
Wire Wire Line
	12550 3375 12550 3800
Wire Wire Line
...
Wire Wire Line
	9950 3025 10575 3025
Wire Wire Line
	10525 3100 10575 3100
Wire Wire Line
	10575 3175 10525 3175
Wire Wire Line
	9525 3250 10575 3250
Wire Wire Line
	3625 1125 4125 1125
Wire Wire Line
	3625 1200 4450 1200
...
U 1 1 586124AF
P 2125 3975
F 0 "U21" H 2125 4225 60  0000 C CNN
F 1 "EPCS4" H 2125 3725 60  0000 C CNN
F 2 "Housings_SOIC:SOIC-8_3.9x4.9mm_Pitch1.27mm" H 2075 3975 60  0001 C CNN
...
U 1 1 58612A86
P 1700 4125
F 0 "#PWR2" H 1700 3875 50  0001 C CNN
F 1 "GND" H 1700 3975 50  0000 C CNN
F 2 "" H 1700 4125 50  0000 C CNN
F 3 "" H 1700 4125 50  0000 C CNN
	1    1700 4125
	1    0    0    -1  
$EndComp
$Comp
...
U 1 1 586140D5
P 2650 3775
F 0 "#PWR3" H 2750 3825 20  0001 C CNN
F 1 "+3V3" H 2650 3865 30  0000 C CNN
F 2 "" H 2650 3775 60  0000 C CNN
F 3 "" H 2650 3775 60  0000 C CNN
	1    2650 3775
	1    0    0    -1  
$EndComp
Wire Wire Line
...
U 1 1 58614C3F
P 1575 4025
F 0 "#PWR1" H 1675 4075 20  0001 C CNN
F 1 "+3V3" V 1625 4075 30  0000 C CNN
...
U 1 1 586157C2
P 2650 4350
F 0 "C64" H 2675 4450 50  0000 L CNN
F 1 "0,1" H 2675 4250 50  0000 L CNN
F 2 "Capacitors_SMD:C_0603" H 2688 4200 50  0001 C CNN
...
U 1 1 586161B6
P 2650 4500
F 0 "#PWR4" H 2650 4250 50  0001 C CNN
...
U 1 1 5883464A
P 14050 3800
F 0 "C71" H 14075 3900 50  0000 L CNN
F 1 "0,1" H 14075 3700 50  0000 L CNN
F 2 "Capacitors_SMD:C_0603" H 14088 3650 50  0001 C CNN
...
U 1 1 5883481A
P 14050 3950
F 0 "#PWR18" H 14050 3700 50  0001 C CNN
...
Text GLabel 13975 3400 0    60   Input ~ 0
+1V8
Wire Wire Line
	13975 3400 14050 3400
Wire Wire Line
	14050 3400 14050 3650
Wire Wire Line
	12500 3375 12550 3375
Connection ~ 12550 3525
$Comp
L C C72
U 1 1 588362E2
P 14300 3800
F 0 "C72" H 14325 3900 50  0000 L CNN
F 1 "0,1" H 14325 3700 50  0000 L CNN
F 2 "Capacitors_SMD:C_0603" H 14338 3650 50  0001 C CNN
F 3 "" H 14300 3800 50  0000 C CNN
	1    14300 3800
	1    0    0    -1  
$EndComp
Wire Wire Line
	14300 3950 14050 3950
Connection ~ 14050 3950
Connection ~ 14300 3950
Text HLabel 15100 8275 2    60   BiDi ~ 0
USBAD[0:15]
Text GLabel 7050 8850 0    39   Input ~ 0
ETHSD12
Text GLabel 7050 8775 0    39   Input ~ 0
ETHSD11
...
ETHSD1
Text GLabel 7050 8100 0    39   Input ~ 0
ETHSD9
Text GLabel 7050 7425 0    39   Input ~ 0
ETHSD8
Text GLabel 7050 6950 0    39   Input ~ 0
ETHSD3
Text GLabel 7050 6875 0    39   Input ~ 0
ETHSD2
Text GLabel 7050 6425 0    39   Input ~ 0
ETHSD7
Text GLabel 7050 6125 0    39   Input ~ 0
ETHSD0
Text GLabel 7050 6050 0    39   Input ~ 0
ETHSD14
Text GLabel 7050 5450 0    39   Input ~ 0
ETHSD6
...
U 1 1 58A88BAD
P 4050 4025
F 0 "Y3" H 4175 4225 50  0000 L CNN
F 1 "Crystal_GND24" H 4175 4150 50  0000 L CNN
F 2 "Crystals:Crystal_SMD_3225-4pin_3.2x2.5mm" H 4050 4450 50  0000 C CNN
F 3 "" H 4050 4025 50  0000 C CNN
	1    4050 4025
	1    0    0    1   
$EndComp
$Comp
...
U 1 1 58A8994C
P 4050 4225
F 0 "#PWR8" H 4050 3975 50  0001 C CNN
...
Wire Wire Line
	4200 4025 4825 4025
Text GLabel 4825 4025 2    60   Output ~ 0
CLK50
$Comp
L C C128
U 1 1 58A8A4E9
P 4700 4350
F 0 "C128" H 4725 4450 50  0000 L CNN
F 1 "TBD" H 4725 4250 50  0000 L CNN
...
U 1 1 58A8A576
P 3425 4050
F 0 "C127" H 3450 4150 50  0000 L CNN
F 1 "0,01" H 3450 3950 50  0000 L CNN
F 2 "Capacitors_SMD:C_0603" H 3463 3900 50  0001 C CNN
F 3 "" H 3425 4050 50  0000 C CNN
	1    3425 4050
	1    0    0    -1  
$EndComp
$Comp
...
U 1 1 58A8A622
P 3425 4200
F 0 "#PWR6" H 3425 3950 50  0001 C CNN
...
U 1 1 58A8A9F2
P 4700 4500
F 0 "#PWR9" H 4700 4250 50  0001 C CNN
...
Text GLabel 4125 1650 2    60   Input ~ 0
CLK50
Wire Wire Line
	10525 3025 10525 3100
Connection ~ 10525 3025
Text Notes 3875 4825 0    60   ~ 0
ABRACON ASE-50 (3.3V)\nASE2 (2.5V)
$Comp
L R_Small R34
U 1 1 58AC8039
P 4450 950
F 0 "R34" H 4509 996 50  0000 L CNN
F 1 "10K" H 4509 905 50  0000 L CNN
F 2 "Resistors_SMD:R_0603" H 0   150 50  0001 C CNN
...
U 1 1 58AC91F8
P 4725 950
F 0 "R35" H 4784 996 50  0000 L CNN
F 1 "10K" H 4784 905 50  0000 L CNN
F 2 "Resistors_SMD:R_0603" H 275 150 50  0001 C CNN
F 3 "" H 275 150 50  0001 C CNN
	1    4725 950 
	1    0    0    -1  
$EndComp
$Comp
...
U 1 1 58AC9290
P 5000 950
F 0 "R36" H 5059 996 50  0000 L CNN
F 1 "10K" H 5059 905 50  0000 L CNN
F 2 "Resistors_SMD:R_0603" H 550 150 50  0001 C CNN
...
CONF_DONE
Text Label 3675 1725 0    60   ~ 0
nSTATUS
$Comp
L GND #PWR11
U 1 1 58ACB779
P 4975 1825
F 0 "#PWR11" H 4975 1575 50  0001 C CNN
F 1 "GND" H 4975 1675 50  0000 C CNN
F 2 "" H 4975 1825 50  0000 C CNN
F 3 "" H 4975 1825 50  0000 C CNN
	1    4975 1825
	1    0    0    -1  
$EndComp
Wire Wire Line
	3625 1050 4125 1050
Text Label 3825 1050 0    60   ~ 0
DCLK
Wire Wire Line
	3625 975  4125 975 
Text Label 3825 975  0    60   ~ 0
ASDO
$Comp
L R_Small R37
U 1 1 58ACCFF0
P 1275 3925
F 0 "R37" V 1350 3875 50  0000 L CNN
F 1 "25" V 1275 3875 50  0000 L CNN
F 2 "Resistors_SMD:R_0603" H -3175 3125 50  0001 C CNN
...
Wire Wire Line
	2575 4125 2975 4125
Text Label 2975 4025 2    60   ~ 0
DCLK
Text Label 2975 4125 2    60   ~ 0
ASDO
Wire Wire Line
	3625 2050 4125 2050
Text Label 3675 2050 0    60   ~ 0
nCSO
Text Label 1450 3825 0    60   ~ 0
nCSO
Wire Wire Line
	1700 3825 1450 3825
Wire Wire Line
...
U 1 1 58AD59B5
P 4975 1725
F 0 "R38" H 5034 1771 50  0000 L CNN
F 1 "000" H 5034 1680 50  0000 L CNN
F 2 "Resistors_SMD:R_0603" H 525 925 50  0001 C CNN
F 3 "" H 525 925 50  0001 C CNN
	1    4975 1725
	1    0    0    -1  
$EndComp
Wire Wire Line
...
Wire Wire Line
	4975 1575 4975 1625
Text Label 3650 1575 0    60   ~ 0
nCE
Connection ~ 12550 1875
$Comp
L +3V3 #PWR10
U 1 1 58AD9DC7
P 4725 750
F 0 "#PWR10" H 4825 800 20  0001 C CNN
F 1 "+3V3" H 4725 840 30  0000 C CNN
F 2 "" H 4725 750 60  0000 C CNN
F 3 "" H 4725 750 60  0000 C CNN
	1    4725 750 
	1    0    0    -1  
$EndComp
Wire Wire Line
...
Connection ~ 4725 800 
Wire Wire Line
	10525 3175 10525 3375
Connection ~ 10525 3250
$Comp
L +3V3 #PWR7
U 1 1 58B48267
P 4050 3625
F 0 "#PWR7" H 4150 3675 20  0001 C CNN
F 1 "+3V3" H 4050 3715 30  0000 C CNN
F 2 "" H 4050 3625 60  0000 C CNN
F 3 "" H 4050 3625 60  0000 C CNN
	1    4050 3625
	1    0    0    -1  
$EndComp
$Comp
...
U 1 1 58B48E86
P 3725 3875
F 0 "R45" H 3784 3921 50  0000 L CNN
F 1 "000" H 3784 3830 50  0000 L CNN
F 2 "Resistors_SMD:R_0603" H -725 3075 50  0001 C CNN
F 3 "" H -725 3075 50  0001 C CNN
	1    3725 3875
	1    0    0    -1  
$EndComp
Wire Wire Line
...
Text GLabel 9950 3025 0    60   Input ~ 12
+2V5
Text Notes 9150 4225 0    60   ~ 0
May be able to share VCCD_PLL with VCCINT with a proper isolation filter. With\nproper isolation filter, limit the VCCD_PLL power supply to ±3% maximum ripple\nvoltage.
Connection ~ 10525 2200
$Comp
L C C132
U 1 1 58B4A4B4
P 10525 3525
F 0 "C132" H 10550 3625 50  0000 L CNN
F 1 "0,1" H 10550 3425 50  0000 L CNN
F 2 "Capacitors_SMD:C_0402" H 10563 3375 50  0001 C CNN
F 3 "" H 10525 3525 50  0000 C CNN
	1    10525 3525
	1    0    0    -1  
$EndComp
$Comp
...
U 1 1 58B4A83F
P 10525 3675
F 0 "#PWR13" H 10525 3425 50  0001 C CNN
F 1 "GND" H 10525 3525 50  0000 C CNN
F 2 "" H 10525 3675 50  0000 C CNN
F 3 "" H 10525 3675 50  0000 C CNN
	1    10525 3675
	1    0    0    -1  
$EndComp
Wire Wire Line
	10525 1600 10525 2725
Wire Wire Line
	9525 3250 9525 2725
Wire Wire Line
	9525 2725 10525 2725
$Comp
L C C135
U 1 1 58B4B61E
P 10250 3525
F 0 "C135" H 10275 3625 50  0000 L CNN
F 1 "0,1" H 10275 3425 50  0000 L CNN
F 2 "Capacitors_SMD:C_0402" H 10288 3375 50  0001 C CNN
F 3 "" H 10250 3525 50  0000 C CNN
	1    10250 3525
	1    0    0    -1  
$EndComp
Wire Wire Line
	10250 3375 10250 3250
Connection ~ 10250 3250
$Comp
L GND #PWR12
U 1 1 58B4B860
P 10250 3675
F 0 "#PWR12" H 10250 3425 50  0001 C CNN
F 1 "GND" H 10250 3525 50  0000 C CNN
F 2 "" H 10250 3675 50  0000 C CNN
F 3 "" H 10250 3675 50  0000 C CNN
	1    10250 3675
	1    0    0    -1  
$EndComp
$EndSCHEMATC
